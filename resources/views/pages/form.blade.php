...
@section('page-body')
                ...
                <div class="col-12">
                  ...
                  "
                                        ...
                                        <div class="col-md-6 col-xl-12">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label">Input with checkbox or
                                                    radios</label>
                                                <div class="input-group mb-2">
                                                    <span class="input-group-text">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label">Input with prepended
                                                    text</label>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label">Input with appended icon
                                                    links</label>
                                                <div class="input-group input-group-flat">
                                                    <input type="text" class="form-control" autocomplete="off" />
                                                    <span class="input-group-text">
                                                        <a href="#" class="link-secondary" title="Clear search"
                                                        ...
                                                        <a href="#" class="link-secondary ms-2"
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon"
                                                                ...
                                                                <line x1="18" y1="4" x2="18"
                                                                    y2="5" />
                                                                <line x1="18" y1="9" x2="18"
                                                                    y2="20" />
                                                            </svg>
                                                        </a>
                                                        <a href="#" class="link-secondary ms-2 disabled"
                                                            title="Add notification" data-bs-toggle="tooltip">
                                ...
                                <div class="col-xl-4">
                                    <div class="row">
                                        <div class="col-md-6 col-xl-12">
                                                    ...
                                                    <div class="col-auto">
                                                        <label class="form-colorinput">
                                                            <input name="color-rounded" type="radio" value="dark"
                                                                class="form-colorinput-input" />
                                                            <span
                                                                class="form-colorinput-color bg-dark rounded-circle"></span>
                                                        </label>
                                                    </div>
                                                    <div class="col-auto">
                                                        <label class="form-colorinput form-colorinput-light">
                                                            <input name="color-rounded" type="radio" value="white"
                                                                class="form-colorinput-input" checked />
                                                            <span
                                                                class="form-colorinput-color bg-white rounded-circle"></span>
                                                        </label>
                                                    </div>
                                                    <div class="col-auto">
                                                        <label class="form-colorinput">
                                                            <input name="color-rounded" type="radio" value="blue"
                                                                class="form-colorinput-input" />
                                                            <span
                                                                class="form-colorinput-color bg-blue rounded-circle"></span>
                                                        </label>
                                                    </div>
                                                    <div class="col-auto">
                                                        <label class="form-colorinput">
                                                            <input name="color-rounded" type="radio" value="azure"
                                                                class="form-colorinput-input" />
                                                            <span
                                                                class="form-colorinput-color bg-azure rounded-circle"></span>
                                                        </label>
                                                    </div>
                                                    <div class="col-auto">
                                                        <label class="form-colorinput">
                                                            <input name="color-rounded" type="radio" value="indigo"
                                                                class="form-colorinput-input" />
                                                            <span
                                                                class="form-colorinput-color bg-indigo rounded-circle"></span>
                                                        </label>
                                                    </div>
                                                    <div class="col-auto">
                                                        <label class="form-colorinput">
                                                            <input name="color-rounded" type="radio" value="purple"
                                                                class="form-colorinput-input" />
                                                            <span
                                                                class="form-colorinput-color bg-purple rounded-circle"></span>
                                                        </label>
                                                    </div>
                                                    <div class="col-auto">
                                                        <label class="form-colorinput">
                                                            <input name="color-rounded" type="radio" value="pink"
                                                                class="form-colorinput-input" />
                                                            <span
                                                                class="form-colorinput-color bg-pink rounded-circle"></span>
                                                        </label>
                                                    </div>
                                                    <div class="col-auto">
                                                        <label class="form-colorinput">
                                                            <input name="color-rounded" type="radio" value="red"
                                                                class="form-colorinput-input" />
                                                            <span
                                                                class="form-colorinput-color bg-red rounded-circle"></span>
                                                        </label>
                                                    </div>
                                                    <div class="col-auto">
                                                        <label class="form-colorinput">
                                                            <input name="color-rounded" type="radio" value="orange"
                                                                class="form-colorinput-input" />
                                                            <span
                                                                class="form-colorinput-color bg-orange rounded-circle"></span>
                                                        </label>
                                                    </div>
                                                    <div class="col-auto">
                                                        <label class="form-colorinput">
                                                            <input name="color-rounded" type="radio" value="yellow"
                                                                class="form-colorinput-input" />
                                                            <span
                                                                class="form-colorinput-color bg-yellow rounded-circle"></span>
                                                        </label>
                                                    </div>
                                                    <div class="col-auto">
                                                        <label class="form-colorinput">
                                                            <input name="color-rounded" type="radio" value="lime"
                                                                class="form-colorinput-input" />
                                                            <span
                                                                class="form-colorinput-color bg-lime rounded-circle"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label">Validation States
                                                </label>
                                            ...
                                            <fieldset class="form-fieldset">
                                                ...
                                                <label class="form-check">
                                                    ...
                                                    <span class="form-check-label required">I agree to the Terms &
                                                        Conditions</span>
                                                </label>
                                            </fieldset>
                                        </div>
                                        <div class="col-md-6 col-xl-12">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label">Selectgroup with icons and
                                                    text</label>
                                                <div class="form-selectgroup">
                                                    <label class="form-selectgroup-item">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="btn-group w-100" role="group">
                                                    ...
                                                    <label for="btn-radio-basic-1" type="button" class="btn">1
                                                        min</label>
                                                    <input type="radio" class="btn-check" name="btn-radio-basic"
                                                        id="btn-radio-basic-2" autocomplete="off" />
                                                    <label for="btn-radio-basic-2" type="button" class="btn">5
                                                        min</label>
                                                    <input type="radio" class="btn-check" name="btn-radio-basic"
                                                        id="btn-radio-basic-3" autocomplete="off" />
                                                    <label for="btn-radio-basic-3" type="button" class="btn">10
                                                        min</label>
                                                    <input type="radio" class="btn-check" name="btn-radio-basic"
                                                        id="btn-radio-basic-4" autocomplete="off" />
                                                    <label for="btn-radio-basic-4" type="button" class="btn">30
                                                        min</label>
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Buttons group with
                                                    dropdown</label>
                                                <div class="btn-group w-100" role="group">
                                                    <input type="radio" class="btn-check" name="btn-radio-dropdown"
                                                        id="btn-radio-dropdown-1" autocomplete="off" checked />
                                                    <label for="btn-radio-dropdown-1" type="button"
                                                        class="btn">Option 1</label>
                                                    <input type="radio" class="btn-check" name="btn-radio-dropdown"
                                                        id="btn-radio-dropdown-2" autocomplete="off" />
                                                    <label for="btn-radio-dropdown-2" type="button"
                                                        class="btn">Option 2</label>
                                                    <div class="btn-group" role="group">
                                                        <input type="radio" class="btn-check"
                                                            name="btn-radio-dropdown" id="btn-radio-dropdown-dropdown"
                                                            autocomplete="off" />
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <label class="form-label">Vertical buttons
                                                            group</label>
                                                        <div class="btn-group-vertical w-100" role="group">
                                                            <input type="radio" class="btn-check"
                                                                name="btn-radio-vertical" id="btn-radio-vertical-1"
                                                                autocomplete="off" checked />
                                                            <label for="btn-radio-vertical-1" type="button"
                                                                class="btn">Button 1</label>
                                                            <input type="radio" class="btn-check"
                                                                name="btn-radio-vertical" id="btn-radio-vertical-2"
                                                                autocomplete="off" />
                                                            <label for="btn-radio-vertical-2" type="button"
                                                                class="btn">Button 2</label>
                                                            <input type="radio" class="btn-check"
                                                                name="btn-radio-vertical" id="btn-radio-vertical-3"
                                                                autocomplete="off" />
                                                            <label for="btn-radio-vertical-3" type="button"
                                                                class="btn">Button 3</label>
                                                            <input type="radio" class="btn-check"
                                                                name="btn-radio-vertical" id="btn-radio-vertical-4"
                                                                autocomplete="off" />
                                                            <label for="btn-radio-vertical-4" type="button"
                                                                class="btn">Button 4</label>
                                                            <input type="radio" class="btn-check"
                                                                name="btn-radio-vertical" id="btn-radio-vertical-5"
                                                                autocomplete="off" />
                                                            <label for="btn-radio-vertical-5" type="button"
                                                                class="btn">Button 5</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <label class="form-label">Vertical with
                                                            dropdown</label>
                                                        <div class="btn-group-vertical w-100" role="group">
                                                            <input type="radio" class="btn-check"
                                                                name="btn-radio-vertical-dropdown"
                                                                id="btn-radio-vertical-dropdown-1" autocomplete="off"
                                                                checked />
                                                            <label for="btn-radio-vertical-dropdown-1" type="button"
                                                                class="btn">Button 1</label>
                                                            <input type="radio" class="btn-check"
                                                                name="btn-radio-vertical-dropdown"
                                                                id="btn-radio-vertical-dropdown-2" autocomplete="off" />
                                                            <label for="btn-radio-vertical-dropdown-2" type="button"
                                                                class="btn">Button 2</label>
                                                            <input type="radio" class="btn-check"
                                                                name="btn-radio-vertical-dropdown"
                                                                id="btn-radio-vertical-dropdown-3" autocomplete="off" />
                                                            <label for="btn-radio-vertical-dropdown-3" type="button"
                                                                class="btn">Button 3</label>
                                                            <input type="radio" class="btn-check"
                                                                name="btn-radio-vertical-dropdown"
                                                                id="btn-radio-vertical-dropdown-4" autocomplete="off" />
                                                            <label for="btn-radio-vertical-dropdown-4" type="button"
                                                                class="btn">Button 4</label>
                                                            <div class="btn-group" role="group">
                                                                <input type="radio" class="btn-check"
                                                                    name="btn-radio-vertical-dropdown"
                                                ...
                                                <div class="btn-group w-100" role="group">
                                                    ...
                                                    <label for="btn-radio-toolbar-2" class="btn btn-icon">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon"
                                                            ...
                                                            stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                                            <line x1="11" y1="5" x2="17"
                                                                y2="5" />
                                                            <line x1="7" y1="19" x2="13"
                                                                y2="19" />
                                                            <line x1="14" y1="5" x2="10"
                                                                y2="19" />
                                                        </svg>
                                                    </label>
                                                    <input type="radio" class="btn-check" name="btn-radio-toolbar"
                                                    ...
                                                    <label for="btn-radio-toolbar-5" class="btn btn-icon">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon"
                                                            ...
                                                            <line x1="8.6" y1="8.6" x2="19"
                                                                y2="19" />
                                                            <line x1="8.6" y1="15.4" x2="19"
                                                                y2="5" />
                                                        </svg>
                                                    </label>
                                                    <input type="radio" class="btn-check" name="btn-radio-toolbar"
                                ...
                                <div class="col-xl-4">
                                    <div class="row">
                                        <div class="col-md-6 col-xl-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div>
                                                    ...
                                                    <label class="form-check">
                                                        ...
                                                        <span class="form-check-label">Checked checkbox
                                                            input</span>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label">Checkboxes with
                                                    description</label>
                                                <label class="form-check">
                                                    <input class="form-check-input" type="checkbox" />
                                                ...
                                                <label class="form-check">
                                                    <input class="form-check-input" type="checkbox" />
                                                    <span class="form-check-label">
                                                        Longer checkbox item that
                                                        wraps on to two separate
                                                        lines
                                                    </span>
                                                    <span class="form-check-description">
                                                        Ab alias aut, consequuntur
                                                        cumque esse eveniet incidunt
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <label class="form-check form-switch">
                                                    <input class="form-check-input" type="checkbox" />
                                                    <span class="form-check-label">I agree with terms and
                                                        conditions</span>
                                                </label>
                                            </div>
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-6 col-xl-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="range" class="form-range mb-2" value="40"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col">
                                                        <a href="#" class="btn w-100">
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                class="icon text-twitter" width="24"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select type="text" class="form-select" placeholder="Select a date"
                                                    ...
                                                    <optgroup label="People">
                                                        <option value="Chuck Tesla">
                                                            Chuck Tesla
                                                        </option>
                                                        <option value="Elon Musk">
                                                            Elon Musk
                                                        </option>
                                                        <option value="Paweł Kuna">
                                                            Paweł Kuna
                                                        </option>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select type="text" class="form-select" id="select-labels"
                                                    value="">
                                                    <option value="copy"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select type="text" class="form-select is-invalid"
                                                    id="select-countries-invalid" value="">
                                                    <option value="pl">
                                                        Poland
                                                    </option>
                                                    <option value="de">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="input-icon">
                                <input type="text" value="prj_5ae74426fe935327a8fa178b07d84ad9"
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-subtitle">
                                The version of Node.js that is used in the
                                Build Step and for Serverless Functions. A new
                                Deployment is required for your changes to take
                                effect.
                            </p>
                            <select class="form-select">
                                <option>14.x</option>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="input-mask" class="form-control"
                                            ...
                                            placeholder="000.000.000.000.000,00" data-mask-reverse="true"
                                            autocomplete="off" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Telephone</label>
                                        <input type="text" name="input-mask" class="form-control"
                                            data-mask="0000-0000" data-mask-visible="true" placeholder="0000-0000"
                                            autocomplete="off" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="input-mask" class="form-control"
                                            data-mask="099.099.099.099" data-mask-visible="true"
                                            placeholder="000.000.000.000" autocomplete="off" />
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    Big belly rude boy, million dollar hustler. Unemployed.</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Email-Address</label>
                                        <input class="form-control" placeholder="your-email@domain.com" />
...
@section('page-libs')
    <script src="./dist/libs/nouislider/dist/nouislider.min.js?1668287865" defer></script>
    <script src="./dist/libs/litepicker/dist/litepicker.js?1668287865" defer></script>
    <script src="./dist/libs/tom-select/dist/js/tom-select.base.min.js?1668287865" defer></script>
@stop
...
@section('page-scripts')
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            window.TomSelect &&
                new TomSelect(
                    (el = document.getElementById("select-tags-advanced")), {
                        copyClassesToDropdown: false,
                        dropdownClass: "dropdown-menu ts-dropdown",
                        optionClass: "dropdown-item",
                        controlInput: "<input>",
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            window.TomSelect &&
                new TomSelect(
                    (el = document.getElementById("select-optgroups")), {
                        copyClassesToDropdown: false,
                        dropdownClass: "dropdown-menu ts-dropdown",
                        optionClass: "dropdown-item",
                        controlInput: "<input>",
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            window.TomSelect &&
                new TomSelect(
                    (el = document.getElementById("select-countries-valid")), {
                        copyClassesToDropdown: false,
                        dropdownClass: "dropdown-menu ts-dropdown",
                        optionClass: "dropdown-item",
                        controlInput: "<input>",
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            window.TomSelect &&
                new TomSelect(
                    (el = document.getElementById("select-countries-invalid")), {
                        copyClassesToDropdown: false,
                        dropdownClass: "dropdown-menu ts-dropdown",
                        optionClass: "dropdown-item",
                        controlInput: "<input>",
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            let sliderTriggerList = [].slice.call(
            ...
            sliderTriggerList.map(function(sliderTriggerEl) {
                ...
                if (sliderTriggerEl.getAttribute("data-slider")) {
                    options = JSON.parse(
                        sliderTriggerEl.getAttribute("data-slider")
                    );
                }
